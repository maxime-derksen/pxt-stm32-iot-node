...
void onDistanceConditionChanged2(DistanceCondition condition, int distance, DistanceUnit unit, Action handler) {
...
//% parts="distance"
//% weight=26
float distance2(DistanceUnit unit) {
