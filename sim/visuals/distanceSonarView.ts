...
namespace pxsim{
   export class DistanceSonarState { 
       constructor(public distanceSonarState: AnalogSensorState, public distanceUnitSonar : DistanceUnitSonar) {
...
namespace pxsim.visuals {    
   ...
   const SONAR_PART_WIDTH = 490.47632;
   const SONAR_PART_HEIGHT = 208.97415;
